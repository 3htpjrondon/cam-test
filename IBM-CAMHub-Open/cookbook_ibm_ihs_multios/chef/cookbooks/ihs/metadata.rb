...
attribute 'ihs/os_perms',
          ...
          :selectable => 'true',
          :type => 'string'
attribute 'ihs/os_users/ihs/comment',
          :default => 'IBM HTTP Server OS user',
          :description => 'A comment associated with the IBM HTTP Server',
          :displayname => 'IBM HTTP Server OS user comment',
          :hidden => 'true',
          :immutable_after_create => 'true',
          :parm_type => 'node',
          :precedence_level => 'node',
...
attribute 'ihs/os_users/ihs/shell',
          ...
          :selectable => 'true',
          :type => 'string'
attribute 'ihs/os_users/ihsrun/comment',
          :default => 'IBM HTTP Server OS worker user',
          :description => 'A comment associated with the IBM HTTP Server worker user',
          :displayname => 'IBM HTTP Server OS worker user comment',
          :hidden => 'true',
          :immutable_after_create => 'true',
          :parm_type => 'node',
          :precedence_level => 'node',
          ...
          :selectable => 'true',
          :type => 'string'
attribute 'ihs/os_users/ihsrun/gid',
          :default => '',
          :description => 'The group name for the IBM HTTP Server worker user',
          :displayname => 'IBM HTTP Server OS worker user group name',
          :hidden => 'true',
          :immutable_after_create => 'true',
          :parm_type => 'node',
          :precedence_level => 'node',
          ...
          :selectable => 'true',
          :type => 'string'
attribute 'ihs/os_users/ihsrun/home',
          :default => 'default',
          :description => 'The IBM HTTP Server worker user home directory',
          :displayname => 'IBM HTTP Server OS worker user home directory',
          :hidden => 'false',
          :immutable_after_create => 'true',
          :parm_type => 'node',
          :precedence_level => 'node',
          ...
          :selectable => 'true',
          :type => 'string'
attribute 'ihs/os_users/ihsrun/name',
          :default => '',
          :description => 'The worker username for IBM HTTP Server',
          :displayname => 'IBM HTTP Server OS worker username',
          :hidden => 'false',
          :immutable_after_create => 'true',
          :parm_type => 'node',
          :precedence_level => 'node',
          ...
          :selectable => 'true',
          :type => 'string'
attribute 'ihs/os_users/ihsrun/shell',
          :default => '/sbin/nologin',
          :description => 'Location of the IBM HTTP Server operating system worker user shell',
          :displayname => 'IBM HTTP Server OS worker user shell',
          :hidden => 'true',
          :immutable_after_create => 'true',
          :parm_type => 'node',
          :precedence_level => 'node',
