...
# <md>attribute 'ihs/os_users/ihs/comment',
...
# <> IBM HTTP Server OS worker user
# <md>attribute 'ihs/os_users/ihsrun/name',
# <md>          :displayname => 'IBM HTTP Server OS worker username',
# <md>          :description => 'The worker username for IBM HTTP Server',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
# <md>          :default => '',
# <md>          :selectable => 'true',
...
# <md>          :hidden => 'false',
# <md>          :secret => 'false'
default['ihs']['os_users']['ihsrun']['name'] = ''

# <> IBM HTTP Server OS worker user group
# <md>attribute 'ihs/os_users/ihsrun/gid',
# <md>          :displayname => 'IBM HTTP Server OS worker user group name',
# <md>          :description => 'The group name for the IBM HTTP Server worker user',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
# <md>          :default => '',
# <md>          :selectable => 'true',
...
# <md>          :hidden => 'true',
# <md>          :secret => 'false'
default['ihs']['os_users']['ihsrun']['gid'] = ''

# <> IBM HTTP Server OS worker user home directory
# <md>attribute 'ihs/os_users/ihsrun/home',
# <md>          :displayname => 'IBM HTTP Server OS worker user home directory',
# <md>          :description => 'The IBM HTTP Server worker user home directory',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
# <md>          :default => 'default',
# <md>          :selectable => 'true',
...
# <md>          :hidden => 'false',
# <md>          :secret => 'false'
default['ihs']['os_users']['ihsrun']['home'] = 'default'

# <> IBM HTTP Server OS worker user comment
# <md>attribute 'ihs/os_users/ihsrun/comment',
# <md>          :displayname => 'IBM HTTP Server OS worker user comment',
# <md>          :description => 'A comment associated with the IBM HTTP Server worker user',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
# <md>          :default => 'IBM HTTP Server OS worker user',
# <md>          :selectable => 'true',
# <md>          :immutable_after_create => 'true',
# <md>          :precedence_level => 'node',
# <md>          :parm_type => 'node',
# <md>          :hidden => 'true',
# <md>          :secret => 'false'
default['ihs']['os_users']['ihsrun']['comment'] = 'IBM HTTP Server OS worker user'

# <> IBM HTTP Server OS worker shell
# <md>attribute 'ihs/os_users/ihsrun/shell',
# <md>          :displayname => 'IBM HTTP Server OS worker user shell',
# <md>          :description => 'Location of the IBM HTTP Server operating system worker user shell',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
# <md>          :default => '/sbin/nologin',
# <md>          :selectable => 'true',
...
# <md>          :hidden => 'true',
# <md>          :secret => 'false'
default['ihs']['os_users']['ihsrun']['shell'] = '/sbin/nologin'
