...
def load_current_resource
  # CHEF 12 @current_resource = Chef::Resource::WasWebserver.new(@new_resource.name)
  @current_resource = Chef::Resource.resource_for_node(:was_webserver, node).new(@new_resource.name)
