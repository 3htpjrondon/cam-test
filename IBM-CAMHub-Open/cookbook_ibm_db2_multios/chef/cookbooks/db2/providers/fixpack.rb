...
def load_current_resource
  # CHEF 12 @current_resource = Chef::Resource::Db2Fixpack.new(@new_resource.name)
  @current_resource = Chef::Resource.resource_for_node(:db2_fixpack, node).new(@new_resource.name)
